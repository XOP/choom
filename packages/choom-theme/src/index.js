...
export const DIRECTION_XY_TYPES = ["x", "y", "xy"];
export const DIRECTION_SIDES_TYPES = ["top", "bottom", "left", "right"];
export const DIRECTION_TYPES = [
  ...DIRECTION_XY_TYPES,
  ...DIRECTION_SIDES_TYPES,
];
...
export const FLEX_DIR_TYPES = ["row", "column"];
